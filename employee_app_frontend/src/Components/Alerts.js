...
export class Alerts extends Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (message !== prevProps.message) {
      if (message.addDep) alert.success(message.addDep);
      if (message.deleteDep) alert.success(message.deleteDep);
      if (message.updateDep) alert.success(message.updateDep);
